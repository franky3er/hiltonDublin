		...
		if(selectedReservationID != null){
			...
			if(reservations != null){
				if(!reservations.isEmpty()){
					dbConnection.deleteReservations(selectedReservationID, null, null, null, null, null);
					request.setAttribute("cancelReservationSuccessful", "1");
				} else {
					request.setAttribute("cancelReservationFailed", "1");
				}
			} else {
				request.setAttribute("cancelReservationFailed", "1");
			}
